                ...
                <li class="row">
                    <div class="list-inner">
                        <el-row>
                            ...
                            <el-col :xs="12" :md="18">
                                <el-select v-model="game_id" @change="getGame" size="small">
                                    <el-option v-for="item in game_ids" :key="item.value" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                            </el-col>
                        ...
                        <el-row>
                            <el-col :xs="24" :md="12" class="pb">
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="12"><a :href="'/player?u=' + game['player_list'][1][0]"
                                            :title="game['player_list'][1][0]">{{ game['player_list'][1][0] }}</a></el-col>
                                </el-row>
                                <el-row>
                            ...
                            <el-col :xs="24" :md="12" class="pb">
                                ...
                                <el-table :data="ranking" style="width: 100%" @row-click="rowClick" class="ranking">
                                    <el-table-column prop="pos" label="#" width="50">
                                    </el-table-column>
                        ...
                        <el-row class="pb">
                            <el-col>
                                <h3>Hand Cash</h3>
                                <line-chart-component :chart-data="datacollection1"
                                    :options="options1"></line-chart-component>
                            </el-col>
                        </el-row>
                        <el-row class="pb">
                            <el-col>
                                <h3>Pot Size</h3>
                                <bar-chart-component :chart-data="datacollection2"
                                    :options="options2"></bar-chart-component>
                            </el-col>
                        </el-row>
                        <el-row class="pb">
                            <el-col>
                                ...
                                <el-table :data="most_hands" style="width: 100%" class="ranking">
                                    ...
                                    <el-table-column prop="_10_to_7_player" label="10 to 7">
                                    </el-table-column>
                                    <el-table-column prop="_6_to_4_player" label="6 to 4">
                                    </el-table-column>
                                    <el-table-column prop="_3_to_1_player" label="3 to 1">
                                    </el-table-column>
                                </el-table>
                            </el-col>
                        </el-row>
                        ...
                        <el-row class="pb">
                            <el-col>
                                ...
                                <el-table :data="longest_wins" style="width: 100%" class="ranking">
                                    ...
                                    <el-table-column prop="total_gain" label="Total gain">
                                    </el-table-column>
                                </el-table>
                            </el-col>
                        </el-row>
                        <el-row class="pb">
                            <el-col>
                                ...
                                <el-table :data="longest_losses" style="width: 100%" class="ranking">
                                    ...
                                    <el-table-column prop="total_loss" label="Total loss">
                                    </el-table-column>
                                </el-table>
                            </el-col>
                        </el-row>
                        ...
                        <el-row class="pb">
                            <el-col>
                                ...
                                <el-table :data="most_bingo" style="width: 100%" class="ranking">
                                    ...
                                    <el-table-column prop="total_count" label="Total count">
                                    </el-table-column>
                                    <el-table-column prop="in_preflop" label="In preflop">
                                    </el-table-column>
                                    <el-table-column prop="first_5_hands" label="First 5 hands">
                                    </el-table-column>
                                    <el-table-column prop="total_won" label="Total won">
                                    </el-table-column>
                                </el-table>
                            </el-col>
                        </el-row>
                        <el-row class="pb">
                            <el-col><small>
                                    ...
                                    **) percental value: number of hands with at least one bet/raise in relation to all
                                    hands played
                                </small></el-col>
                        </el-row>
                        <el-row>
